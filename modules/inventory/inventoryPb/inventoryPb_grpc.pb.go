...
type InventoryGrpcServiceClient interface {
	IsAvailableToSell(ctx context.Context, in *IsAvailableToSellRequest, opts ...grpc.CallOption) (*IsAvailableToSellResponse, error)
}
...
func (c *inventoryGrpcServiceClient) IsAvailableToSell(ctx context.Context, in *IsAvailableToSellRequest, opts ...grpc.CallOption) (*IsAvailableToSellResponse, error) {
	out := new(IsAvailableToSellResponse)
...
type InventoryGrpcServiceServer interface {
	IsAvailableToSell(context.Context, *IsAvailableToSellRequest) (*IsAvailableToSellResponse, error)
...
func (UnimplementedInventoryGrpcServiceServer) IsAvailableToSell(context.Context, *IsAvailableToSellRequest) (*IsAvailableToSellResponse, error) {
...
func _InventoryGrpcService_IsAvailableToSell_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsAvailableToSellRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryGrpcServiceServer).IsAvailableToSell(ctx, req.(*IsAvailableToSellRequest))
	}
