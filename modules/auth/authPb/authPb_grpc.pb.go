...
type AuthGrpcServiceClient interface {
	AccessTokenSearch(ctx context.Context, in *AccessTokenSearchRequest, opts ...grpc.CallOption) (*AccessTokenSearchResponse, error)
	RolesCount(ctx context.Context, in *RolesCountRequest, opts ...grpc.CallOption) (*RolesCountResponse, error)
}
...
func (c *authGrpcServiceClient) AccessTokenSearch(ctx context.Context, in *AccessTokenSearchRequest, opts ...grpc.CallOption) (*AccessTokenSearchResponse, error) {
	out := new(AccessTokenSearchResponse)
...
func (c *authGrpcServiceClient) RolesCount(ctx context.Context, in *RolesCountRequest, opts ...grpc.CallOption) (*RolesCountResponse, error) {
	out := new(RolesCountResponse)
...
type AuthGrpcServiceServer interface {
	AccessTokenSearch(context.Context, *AccessTokenSearchRequest) (*AccessTokenSearchResponse, error)
	RolesCount(context.Context, *RolesCountRequest) (*RolesCountResponse, error)
...
func (UnimplementedAuthGrpcServiceServer) AccessTokenSearch(context.Context, *AccessTokenSearchRequest) (*AccessTokenSearchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AccessTokenSearch not implemented")
}
func (UnimplementedAuthGrpcServiceServer) RolesCount(context.Context, *RolesCountRequest) (*RolesCountResponse, error) {
...
func _AuthGrpcService_AccessTokenSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccessTokenSearchRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthGrpcServiceServer).AccessTokenSearch(ctx, req.(*AccessTokenSearchRequest))
	}
...
func _AuthGrpcService_RolesCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthGrpcServiceServer).RolesCount(ctx, req.(*RolesCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
